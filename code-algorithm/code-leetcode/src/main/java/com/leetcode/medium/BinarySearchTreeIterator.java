...
public class BinarySearchTreeIterator {
    ...
    private List<Integer> valueList = new LinkedList<>();

    public BinarySearchTreeIterator(TreeNode root) {
        iteratorTreeNod(root);
    }
    ...
    private void iteratorTreeNod(TreeNode root) {
        if (root == null)
            return;

        iteratorTreeNod(root.left);
        valueList.add(root.val);
        iteratorTreeNod(root.right);
